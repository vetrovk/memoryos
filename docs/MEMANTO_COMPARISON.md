...
Для нас Memanto сейчас скорее источник идей и возможный будущий optional backend. Он сильнее как готовая semantic memory платформа для многих AI-агентов, но MemoryOS лучше совпадает с нашей целью: локальная, простая, человекочитаемая инженерная память на Markdown и SQLite, которая автоматически сохраняет опыт Codex после задач.
